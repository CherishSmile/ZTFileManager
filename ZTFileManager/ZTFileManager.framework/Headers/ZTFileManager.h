...
//! Project version number for ZTFileManager.
FOUNDATION_EXPORT double ZTFileManagerVersionNumber;

//! Project version string for ZTFileManager.
FOUNDATION_EXPORT const unsigned char ZTFileManagerVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <ZTFileManager/PublicHeader.h>
